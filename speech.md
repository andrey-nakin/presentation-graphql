...
Я не питонист, но есть коллеги питонисты. Наслышан, что у них были проблемы с каким-то из GraphQL клиентов для Питона.
Запросы отправлялись с большой задержкой, вплость до пары секунд. С чем это связано, не могу сказать. Возможно,
...
приложение, ничего не могу сказать о том, насколько стабильно и корректно оно работает. И всё, других кандидатов на роль
маршрутизатора у меня в данный момент нет. Эта ниша явно незаполнена, так что амбициозным разработчикам есть чем
заняться.
